...
class SocietiesControllerTest < ActionController::TestCase
  ...
  test "should create society" do
    assert_difference('Society.count') do
      post :create, society: { address: @society.address, area: @society.area, builder: @society.builder, est_date: @society.est_date, name: @society.name, pincode: @society.pincode, start_date: @society.start_date }
    end
  ...
  test "should update society" do
    patch :update, id: @society, society: { address: @society.address, area: @society.area, builder: @society.builder, est_date: @society.est_date, name: @society.name, pincode: @society.pincode, start_date: @society.start_date }
    assert_redirected_to society_path(assigns(:society))
  end
